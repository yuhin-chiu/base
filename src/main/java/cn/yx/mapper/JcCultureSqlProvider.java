...
public class JcCultureSqlProvider {
     ...
     */
    public String insertSelective(JcCultureWithBLOBs record) {
        SQL sql = new SQL();
        ...
        if (record.getContent1() != null) {
            sql.VALUES("content1", "#{content1,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getContent2() != null) {
            sql.VALUES("content2", "#{content2,jdbcType=LONGVARCHAR}");
        }
     ...
     * @mbg.generated Mon Nov 06 14:42:09 CST 2017
     */
    public String selectByExampleWithBLOBs(JcCultureExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Mon Nov 06 14:42:09 CST 2017
     */
    public String updateByPrimaryKeySelective(JcCultureWithBLOBs record) {
        SQL sql = new SQL();
        ...
        if (record.getContent1() != null) {
            sql.SET("content1 = #{content1,jdbcType=LONGVARCHAR}");
        }
        
        if (record.getContent2() != null) {
            sql.SET("content2 = #{content2,jdbcType=LONGVARCHAR}");
        }
